<%-- 
    Document   : About
    Created on : Apr 9, 2023, 12:20:54 PM
    Author     : admin
--%>
...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrap">
	    ...
	    <div class="container">
	    	<a class="navbar-brand" href="index.html"><span class="flaticon-pawprint-1 mr-2"></span>QD Cat Hotel and Spa Centre</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item"><a href="loginchoose.jsp" class="nav-link">Log In</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="homepage.jsp">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>About us <i class="ion-ios-arrow-forward"></i></span></p>
    	...
    	<div class="container">
    		<div class="row d-flex no-gutters">
    			<div class="col-md-5 d-flex">
    				<div class="hero-wrap js-fullheight" style="background-image: url('images/QD cat hotel and spa.jpg');" data-stellar-background-ratio="0.5">
    				</div>
    			</div>
    				...
    				<div class="row">
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					...
	    					<div class="text pl-3">
	    						...
	    						<p>The price were affordable for cat owner</p>
	    					</div>
	    				</div>
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					<div class="icon d-flex align-items-center justify-content-center"><span class="flaticon-customer-service"></span></div>
	    					<div class="text pl-3">
	    						<h4>Experienced and Loving Staff</h4>
	    						<p>QD Cat Hotel and Spa provide the experienced knowledgeable and loving staff.</p>
	    					</div>
	    				</div>
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					<div class="icon d-flex align-items-center justify-content-center"><span class="flaticon-emergency-call"></span></div>
	    					<div class="text pl-3">
	    						<h4>Comfortable modern</h4>
	    						<p>The cat have their own room and have play time</p>
	    					</div>
	    				</div>
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					...
	    					<div class="text pl-3">
	    						...
	    						<p>Location are easy to find and located in the middle of Kuala Nerus City</p>
	    					</div>
	    				</div>
	    			</div>
	        </div>
