<%-- 
    Document   : home
    Created on : 25 May 2023, 9:37:33 pm
    Author     : Asyraf
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <!-- END nav -->
        <div class="hero-wrap js-fullheight" style="background-image: url('<%= request.getContextPath()%>/images/QD bg1.jpg'); background-size: contain;" data-stellar-background-ratio="0.5">
            <div class="overlay"></div>
            <div class="container">
                <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                    <div class="col-md-11 ftco-animate text-center">
                        <h1 class="mb-4">Welcome <%= user.getUsername()%> </h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 order-md-last">
                        <div class="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-center mb-4 mb-sm-0" style="background-image:url('<%= request.getContextPath()%>/images/about.jpg');">
                            <a href="https://vimeo.com/45830194" class="icon-video popup-vimeo d-flex justify-content-center align-items-center">
                                <span class="fa fa-play"></span>
                            </a>
                        </div>
                        <div class="d-flex mt-3">
                            <div class="img img-2 mr-md-2" style="background-image:url('<%= request.getContextPath()%>/images/about1.jpg');"></div>
                            <div class="img img-2 ml-md-2" style="background-image:url('<%= request.getContextPath()%>/images/about2.jpg');"></div>
                        </div>
                    </div>
