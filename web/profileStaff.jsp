  ...
  position: relative;
    ...
    <body>
        <%
            ...
            String insertQuery = "SELECT * FROM staff WHERE name='" + session.getAttribute("name") + "'";
       ...
       <div class="container">
        <form method="POST" action="editprofile.jsp" enctype='multipart/form-data'>
                            <div class="form-group mb-4">
                                <input type="hidden" name="id" value="<%=myRS.getString(1)%>">
                                <h3>Update <%=myRS.getString(2)%> Profile</h3>
                                <h6>Name</h6>
                                <input type="text" name="name"  class="form-control" id="formGroupExampleInput" value="<%=myRS.getString(2)%>">
                            </div>
                            <div class="form-group mb-4">
                                <h6>Password</h6>
                            ...
                            <div class="form-group mb-4">
                                <h6>Email</h6>
                                <input type="text" name="email"  class="form-control" id="formGroupExampleInput" value="<%=myRS.getString(4)%>">
                            </div>
                            <div class="form-group mb-4">
                                <h6>Address</h6>
                            ...
                            <div class="form-group mb-4">
                                <h6>Phone</h6>
                                <input type="text" name="phone"  class="form-control" id="formGroupExampleInput" value="<%=myRS.getString(6)%>">
                            </div>
                            <button type="submit" name="updateowner" class="btn btn-primary" value="">Update</button>
                             

        </form>
                            <p><button onclick="document.location='Staffhome.jsp';" class="btn btn-primary" >Cancel</button></p>
    </div>
