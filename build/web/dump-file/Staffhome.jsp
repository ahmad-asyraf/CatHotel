            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="addpack.jsp" class="nav-link">Add Package</a></li> 
                        <li class="nav-item"><a href="reservehistory.jsp" class="nav-link">Reservation List</a></li>
                        <li class="nav-item"><a href="profileStaff.jsp" class="nav-link">Profile </a></li>
                    </ul>
                </div>
            </div>
        </nav>
            ...
            <div class="container">
                <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                    <div class="col-md-11 ftco-animate text-center">
                        <h1 class="mb-4">Welcome <%=myRS.getString(2)%> </h1>
